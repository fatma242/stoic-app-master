...
export default function SignUp() {
  ...
  const validateForm = () => {
    ...
    if (!formData.email.trim()) {
      ...
      newErrors.email = "Please enter a valid email"; valid = false;
    }
    ...
    if (formData.password !== formData.confirmPassword) {
      newErrors.confirmPassword = "Passwords don't match"; valid = false;
    }
    setErrors(newErrors);
    return valid;
  };
  ...
  return (
    <View style={styles.container}>
      <Video source={require("../assets/background.mp4")} style={styles.backgroundVideo} isMuted resizeMode={ResizeMode.COVER} shouldPlay isLooping />
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.formContainer}>
            ...
            <TouchableOpacity style={styles.button} onPress={handleSignUp} disabled={loading}>
              <LinearGradient colors={["#16A34A", "#0d4215"]} style={[styles.buttonGradient, loading && styles.buttonDisabled]}>
          ...
          <View style={styles.loginContainer}>
            <Text style={styles.loginText}>
              Already have an account? <Text style={styles.loginLink} onPress={() => router.replace("/login")}>Log in</Text>
            </Text>
          </View>
        </ScrollView>
...
const styles = StyleSheet.create({
  ...
  inputContainer: {
    ...
    paddingHorizontal: 15, paddingVertical: 12, borderRadius: 10, width: "90%", marginBottom: 8,
