 ...
 const [rooms, setRooms] = useState<RoomDTO[]>([]);
  ...
  const fetchVisibleRooms = async () => {
    try {
      ...
      Alert.alert('Error', error instanceof Error ? error.message : 'Could not load rooms');
    }
  };
  ...
  const createRoom = async () => {
    ...
    try {
      ...
      Alert.alert('Error', error instanceof Error ? error.message : 'Could not create room');
    } finally {
      setIsCreating(false);
    }
  };
            ...
            rooms.map(room => (
              ...
              >
                ...
                <Text style={styles.roomDetails}>
                  ...
                  {room.ownerId === userId ? ' Your Room' : ` Owner: ${room.ownerId}`}
                </Text>
              </TouchableOpacity>
            ))
          )}
