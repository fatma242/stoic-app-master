...
const styles = StyleSheet.create({
  ...
  backgroundVideo: { position: "absolute", top: 0, left: 0, right: 0, bottom: 0 },
  overlay: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(0,0,0,0.4)" },
  contentContainer: { flex: 1, width: "100%" },
  scrollContainer: { flexGrow: 1, justifyContent: "center", alignItems: "center", padding: 20 },
  logo: { width: 150, height: 150, marginBottom: 10 },
  title: { fontSize: 24, fontWeight: "bold", color: "#fff", marginBottom: 5, textShadowColor: "rgba(0,0,0,0.3)", textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 3 },
  subtitle: { fontSize: 16, color: "#fff", opacity: 0.8, marginBottom: 30, textShadowColor: "rgba(0,0,0,0.2)", textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2 },
  formContainer: { width: "100%", alignItems: "center", marginBottom: 20 },
  inputContainer: { flexDirection: "row", alignItems: "center", backgroundColor: "rgba(255,255,255,0.9)", paddingHorizontal: 15, paddingVertical: 12, borderRadius: 10, width: "90%", marginBottom: 8, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 3, elevation: 3 },
  ...
  buttonGradient: { padding: 15, borderRadius: 10, alignItems: "center", justifyContent: "center", shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 3, elevation: 3 },
  buttonDisabled: { opacity: 0.7 },
  buttonText: { fontSize: 16, fontWeight: "bold", color: "#fff" },
  errorText: { color: "#ff4444", alignSelf: "flex-start", marginLeft: "5%", marginBottom: 10, fontSize: 13 },
